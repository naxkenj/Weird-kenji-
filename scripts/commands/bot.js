...
module.exports = {
  ...
  start: async function ({ nayan, events, args, Users }) {
    try {
      ...
      if (!msg) {
        const greetings = [
          "lets clap with out using our hands 💀💋",
          "কি বলবা বাবু🐰",
          "বার বার ডাকো কেনো 😩",
          "বট বট না করে আইডি টা অ্যাড করো https://www.facebook.com/profile.php?id=61572891756852🥱",
          "হুম জান তোমার ঠোঁটে উম্মমাহ😷😘",
          "আসসালামু আলাইকুম বলেন আপনার জন্য কি করতে পারি",
          "আমাকে এতো না ডেকে sir kenji কে একটা গফ দে 🥲",
          "jang hanga korba",
          "jang bal falaba🙂"
        ];
